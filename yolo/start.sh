...
# 配置参数
IMAGE_NAME="192.168.1.101:7443/top/yolo:latest"
CONTAINER_NAME="yolo"
APP_LOCAL_DIR="./app"                    # 本地存放 app.py 和 last.pt 的目录
APP_CONTAINER_DIR="/ultralytics/yolo_service"  # 容器内挂载路径
...
if [ $? -eq 0 ]; then
    echo "🎉 容器已成功启动！"
    echo "📄 API 文档请访问: http://localhost:8000/docs"
